...
public class Scoreboard {
	...
	public static void main(String[] args) {
		...
		String[] names = { "Rob", "Mike", "Rose", "Jack", "Anna", "Paul" };
		int[] scores = { 750, 1105, 590, 510, 660, 720 };
		...
		System.out.println("Scoreboard: " + highscores.toString());
		
/*
		GameEntry gE = new GameEntry("Jill", 740);
		highscores.add(gE);
